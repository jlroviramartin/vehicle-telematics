...
public class VehicleTelematics {
     ...
     * File for debug log.
     */
    private final static String DEBUG_LOG_FILE = "/host/flink/debug.log";
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (!TESTING) {
            ...
            inputFile = Paths.get("/host/flink/traffic-3xways").toString();
            outputPath = Paths.get("/host/flink").toString();
        }
        ...
        speedFines.writeAsCsv(Paths.get(outputPath, "speedfines.csv").toString(), FileSystem.WriteMode.OVERWRITE).setParallelism(1);
